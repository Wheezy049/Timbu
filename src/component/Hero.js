    ...
    <div className="flex flex-col justify-center items-center mt-28">
      <div className="relative w-96 h-96 flex justify-center items-center">
        <div className="text-center absolute">
          ...
          <button className="mt-4 px-4 py-2 bg-purple-500 text-sm  text-white rounded hover:bg-purple-600">
            SHOP NOW
          </button>
        </div>
        <div className="absolute w-96 h-96 rotate-clockwise">
        <div className="shoe">
          <img src={image1} alt="image1" className="w-36 h-36" />
        </div>
        <div className="shoe">
          <img src={image2} alt="image2" className="w-36 h-36" />
        </div>
        <div className="shoe">
          <img src={image3} alt="image3" className="w-36 h-36" />
        </div>
        <div className="shoe">
          <img src={image7} alt="image7" className="w-36 h-36" />
        </div>
        <div className="shoe">
          <img src={image6} alt="image6" className="w-36 h-36" />
        </div>
        <div className="shoe">
          <img src={image5} alt="image5" className="w-36 h-36" />
        </div>
        <div className="shoe">
          <img src={image4} alt="image4" className="w-36 h-36" />
        </div>
        </div>
      </div>
    </div>
